...
export async function POST() {
  return NextResponse.json({
    ...
    status: "complete",
    happened: "The simulator can produce telemetry, but the AI analysis service is not connected yet.",
    ...
    concept: "Simulation execution and AI analysis should stay replaceable parts of the system.",
  });
}
