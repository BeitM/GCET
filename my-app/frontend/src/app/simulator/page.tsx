...
import { AIFeedback, ScenarioId } from "@/lib/types";
...
export default function SimulatorDashboard(){
 ...
 const [robotId,setRobotId]=useState<RobotPresetId>("turret"),[robotWidth,setRobotWidth]=useState(17),[robotLength,setRobotLength]=useState(17);
 ...
 const choose=(id:string)=>{const next=scenarios.find(s=>s.id===id)!;setScenarioId(id as ScenarioId);setGoal(next.goal);setCode(next.code);setIndex(0);setHasRun(false);setAnalysis(null);stopPlayback()};
